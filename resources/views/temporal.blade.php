...
<hr>
    <div class="container">
        <form class="form-group" action="" method="">
            @csrf
        <div class="row">
            <h4>Secondary Education Detail</h4>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
              ...
              <input type="number" name = "matric-subject" class="form-control"  value=""  placeholder="Percentage..." required>
            </div>
            <div class="col-md-4">
        ...
        {{-- Jamia-Details --}}
        <h4 class = "container mt-3">Higher School Education  Detail</h4>
            <div class="col-md-4">
                <label for="">Percentage</label>
        ...
        <h4 class = "container mt-3">Bachelor Detail (14-Year)</h4>
            <div class="col-md-4">
                <label for="">Percentage</label>
